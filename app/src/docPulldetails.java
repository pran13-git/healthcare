...
public class docPulldetails extends HttpServlet{
      ...
      throws ServletException, IOException {
		...
		try {
			...
			String email_stud=request.getParameter("email_stud");
        ...
        RequestDispatcher rd = request.getRequestDispatcher("WEB-INF\\jsp\\docCprofile.jsp");
