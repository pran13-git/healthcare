  ...
  <body>
    ...
    <div class="menu" id="menu">
      <ul>
        ...
        <li><a href="http://localhost:8088/doctor/pulldetails">My Profile</a></li>
    ...
    <div style="box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1)">
      ...
      <main>
        <div class="container mt-5">
          <h1 class="text-center mb-5" style="text-align: center;font-size: 28px;padding:20px;margin-left: 300px;width: 300px;justify-content: center;">My Profile</h1>
          <form style="margin-left: 180px;" action="http://localhost:8080/doctor/updatedetails" method="get">
